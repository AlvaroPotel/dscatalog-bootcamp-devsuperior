...
public class ProductResourceTests {
	...
	private ProductDTO existinProductDTO;
	...
	void setUp() throws Exception{
		...
		existinProductDTO = ProductFactory.createProductDTO(existingId);
		
		page = new PageImpl<>(List.of(existinProductDTO));
		
		when(service.findById(existingId)).thenReturn(existinProductDTO);
		when(service.findById(nonExistingId)).thenThrow(ResourceNotFoundException.class);
		
		when(service.findAllPaged(any(), anyString(), any())).thenReturn(page);

		when(service.insert(any())).thenReturn(existinProductDTO);

		when(service.update(eq(existingId), any())).thenReturn(existinProductDTO);
	...
	@Test
	public void findAllIdShouldReturnPage() throws Exception{
